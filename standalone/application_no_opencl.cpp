...
class W3DGraphics {
    ...
    public:
        ...
        void onWindowUpdate(){
            ...
            int size = rightClipped.projected.size();

            // Write the clipped triangles to a file 
            writeTrianglesToFile(rightClipped.projected,"correct.tris");
